...
The pipeline uses $\kappa$ = 1.02 $\times$ 10\textsuperscript{$-$3}, a theory-motivated value ($\kappa$ $\approx$ f\textsubscript{kick}/3, see below) adopted in the V18 workbook and consistent with, but not measured by, the FIRAS spectral-distortion bounds (|$\mu$| < 9 $\times$ 10\textsuperscript{$-$5}, |y| < 1.5 $\times$ 10\textsuperscript{$-$5}; Fixsen et al. 1996). Two candidate first-principles expressions sit close to this value:
...
This is a standard isotropic tensor identity and introduces no additional assumptions. The second expression ($\kappa$ = f\textsubscript{kick}/$\pi$) gives a closer numerical match (3.0\% vs 7.9\% above the pipeline value) but the $\pi$ factor has not been rigorously derived; it may arise from path-integral normalisation or 3D-to-1D field statistics. The structural proportionality $\kappa$ $\propto$ f\textsubscript{kick} is robust; the numerical denominator (3, $\pi$, or another order-unity geometric factor) remains an open question (see {\small\protect\path{documentation/Notes/05_Kappa_Derivation.md}} for the full analysis).
...
Environment-linked distance residuals (SN) & Positive $\gamma$\_\allowbreak{}env at low z, consistent sign across independent void catalogues & Sign reversal, or loss of effect under the robustness suite specified in advance, would rule out this environment term \tabularnewline
...
Redshift dependence & If present, the effect should weaken with redshift as finite-range and line-of-sight averaging dominate & No measurable trend with redshift (or the wrong trend) under matched selection would falsify the extension \tabularnewline
\bottomrule
\end{tabularx}
\end{table}

\subsection{Precision consistency checks and sensitivity}
In addition to the qualitative falsifiers above, we ran three orthogonal consistency checks designed to separate large kinematic effects from any small stress photon perturbation. These do not claim a detection of photon coupling. Their purpose is to confirm that the theory-motivated pipeline value $\kappa$ $\approx$ 0.00102 ($\kappa$ $\approx$ f\textsubscript{kick}/3, see Section 2.1; below FIRAS detection sensitivity) is not already excluded by current precision probes and to quantify what sensitivity would be required.
...
Lensing vs RSD (E\_\allowbreak{}G parameter) & E\_\allowbreak{}G from combined lensing and RSD & Six verified analyses (z = 0.27-0.57) scatter about the z-matched GR expectation $\Omega$\_\allowbreak{}m,0/\allowbreak{}f(z) $\approx$ 0.40-0.47; the naive weighted mean is 0.361 $\pm$ 0.027 (0.389 $\pm$ 0.030 excluding the known low CMB-lensing value), 1.4-2.6$\sigma$ below it, with overlapping survey footprints making any combination indicative only & $\Delta$E\_\allowbreak{}G predicted by MTDF photon term is order 0.01 & Most measurements individually agree with GR; known low values (Pullen 2016, Amon 2018) leave a mild literature-level offset; either way the MTDF photon term ($\Delta$E\_\allowbreak{}G  $\sim$ 0.01) is far below current discrimination \tabularnewline
...
\textbf{Observation timeline:}\begin{itemize}
  \item 2026 - DESI redshift-density analysis
  \item 2027 - Euclid weak-lensing correlation
  \item 2028 - Roman Space Telescope mapping
  \item 2029 - Multi-wavelength differential tests
  \item 2030 - Strain-evolution measurement
  \item 2031 - Distance-scale recalibration
\end{itemize}
\end{mdframed}
...
\textit{{\small\protect\path{MTDF_06_Validation_Suite_Appendix.html}}}~[see companion paper].
...
\bibitem{ref1} Fixsen, D. J., Cheng, E. S., Gales, J. M., Mather, J. C., Shafer, R. A., \& Wright, E. L. 1996, "The Cosmic Microwave Background Spectrum from the Full COBE FIRAS Data Set", \emph{ApJ}, 473, 576. DOI: \href{https://doi.org/10.1086/178173}{{\small\protect\path{10.1086/178173}}}
\bibitem{ref2} Brout, D., et al. 2022, "The Pantheon+ Analysis: Cosmological Constraints", \emph{ApJ}, 938, 110. DOI: \href{https://doi.org/10.3847/1538-4357/ac8e04}{{\small\protect\path{10.3847/1538-4357/ac8e04}}}
\bibitem{ref3} Rezaei, S., et al. (DESI Collaboration) 2025, "DESIVAST: Catalogs of Low-Redshift Voids Using Data from the DESI DR1 Bright Galaxy Survey", \emph{ApJ}, 982, 38. DOI: \href{https://doi.org/10.3847/1538-4357/adb559}{{\small\protect\path{10.3847/1538-4357/adb559}}}
\bibitem{ref4} DESI Collaboration 2025, "DESI 2024 VI: Cosmological Constraints from BAO", \emph{JCAP}, 2025, 021. DOI: \href{https://doi.org/10.1088/1475-7516/2025/02/021}{{\small\protect\path{10.1088/1475-7516/2025/02/021}}}
\bibitem{ref5} Aghanim, N., et al. (Planck Collaboration) 2020, "Planck 2018 Results VI: Cosmological Parameters", \emph{A\&A}, 641, A6. DOI: \href{https://doi.org/10.1051/0004-6361/201833910}{{\small\protect\path{10.1051/0004-6361/201833910}}}
\bibitem{ref6} Pullen, A. R., Alam, S., He, S., \& Ho, S. 2016, "Constraining Gravity at the Largest Scales through CMB Lensing and Galaxy Velocities", \emph{MNRAS}, 460, 4098. DOI: \href{https://doi.org/10.1093/mnras/stw1249}{{\small\protect\path{10.1093/mnras/stw1249}}}
\bibitem{ref7} Padamsee, H. S. 2001, "The Science and Technology of Superconducting Cavities for Accelerators", \emph{Supercond. Sci. Technol.}, 14, R28. DOI: \href{https://doi.org/10.1088/0953-2048/14/4/202}{{\small\protect\path{10.1088/0953-2048/14/4/202}}}
\end{thebibliography}
}

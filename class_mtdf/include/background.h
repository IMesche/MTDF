...
struct background
{
  ...
  int index_bg_rho_mtdf_efe;  /**< MTDF early field energy density */
  int index_bg_w_mtdf_efe;    /**< MTDF early field energy equation of state */
  ...
  short has_mtdf;      /**< presence of MTDF early field energy? */

  //@}

  /** @name - MTDF parameters */

  //@{

  struct mtdf_parameters mtdf; /**< MTDF module parameters */
